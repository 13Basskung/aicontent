...
const PLATFORM_CONFIG = {
    ...
    facebook: {
        ...
        steps: [
            'คลิกลิงก์ "Developer Console" เพื่อสร้าง App การเชื่อมต่อ',
            'เลือก "ผู้บริโภค" และกดถัดไป',
            'กรอกชื่อแอพ และกรอกอีเมลติดต่อของแอพ → กดสร้างแอพ → ระบบจะให้ใส่รหัสผ่านบัญชี Facebook (ให้กรอกรหัสผ่านให้ถูกต้อง) → กดส่ง → จะเจอหน้าแอพของฉัน',
            'กดเมนูซ้ายมือ "การตั้งค่าแอพ" → เลือก "ข้อมูลพื้นฐาน" → ช่อง "ข้อมูลลับของแอพ" ให้กด "แสดง" → กดบันทึกการเปลี่ยนแปลง',
            ...
            'ดูเมนูซ้าย → เลือกเมนู "การเข้าสู่ระบบ Facebook" → เลือก "การตั้งค่า"',
            'เลื่อนลงมาดูที่ช่อง "Valid OAuth Redirect URIs" → Copy ลิงก์ด้านล่างนี้ไปใส่',
            'เลื่อนลงไปล่างสุด → กด "Save changes" (ปุ่มสีน้ำเงิน)',
            'ดูเมนูซ้าย → เลือก "การตั้งค่าแอพ" → เลือก "ข้อมูลพื้นฐาน" → ช่อง "ข้อมูลลับของแอพ" ให้กด "แสดง"',
            'ช่อง "โดเมนของแอพ" ให้ใส่: https://aicontents.vip และ aicontents.vip',
            ...
            'ช่อง "การลบข้อมูลผู้ใช้" ให้เลือก "URL คำแนะนำการลบข้อมูล" และให้ใส่: https://aicontents.vip/data-deletion → เสร็จแล้วกดบันทึกการเปลี่ยนแปลง',
            'โหมดแอพด้านบน ให้เปิดใช้งาน (สังเกตจะเป็นปุ่มสีฟ้า)',
            'Copy ข้อมูล App ID และ App Secret ไปใส่ในหน้าตั้งค่า Facebook (ในเว็บไซต์) ให้ถูกต้องในช่องด้านขวามือ'
        ],
        fields: [
